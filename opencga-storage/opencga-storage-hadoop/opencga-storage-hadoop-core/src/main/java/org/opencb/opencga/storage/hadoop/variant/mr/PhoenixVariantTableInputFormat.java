...
public class PhoenixVariantTableInputFormat
        extends AbstractVariantsTableInputFormat<NullWritable, PhoenixVariantTableInputFormat.ResultSetDBWritable> {
    ...
    public RecordReader<NullWritable, Variant> createRecordReader(InputSplit split, TaskAttemptContext context)
        ...
        return new RecordReaderTransform<>(recordReader, ResultSetDBWritable::getVariant);
    }

    public static class ResultSetDBWritable implements DBWritable, Configurable {
